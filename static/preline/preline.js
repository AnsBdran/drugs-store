					...
					function et(t) {
						...
						if (f) {
							...
							if (
								...
								(T = i),
									(b -=
										(v && O === E && E.visualViewport ? E.visualViewport.height : O[A]) - l.height),
									(b *= h ? 1 : -1);
							if (a === s || ((a === o || a === i) && c === u))
								(I = r),
									(g -=
										(v && O === E && E.visualViewport ? E.visualViewport.width : O[_]) - l.width),
									(g *= h ? 1 : -1);
						}
						var k,
								...
								(e.prototype.show = function () {
									...
									this.group &&
										...
										window.$hsAccordionCollection
											.find(function (e) {
												return (
													e.element.el === t.group.querySelector(':scope > .hs-accordion.active')
												);
											})
											.element.hide();
							...
							function e(e, n, o) {
								...
								return (
									...
									(_.outputLoaderTemplate =
										null !== (m = null == B ? void 0 : B.outputLoaderTemplate) && void 0 !== m
											? m
									...
									(_.groupingType =
										null !== (v = null == B ? void 0 : B.groupingType) && void 0 !== v ? v : null),
									(_.groupingTitleTemplate =
										null !== (y = null == B ? void 0 : B.groupingTitleTemplate) && void 0 !== y
											? y
									...
									(_.tabsWrapperTemplate =
										null !== (g = null == B ? void 0 : B.tabsWrapperTemplate) && void 0 !== g
											? g
									...
									(_.toggle =
										null !== (E = _.el.querySelector('[data-hs-combo-box-toggle]')) && void 0 !== E
											...
											: null),
									(_.toggleClose =
										null !== (O = _.el.querySelector('[data-hs-combo-box-close]')) && void 0 !== O
											? O
											: null),
									(_.toggleOpen =
										null !== (L = _.el.querySelector('[data-hs-combo-box-open]')) && void 0 !== L
											? L
											: null),
							...
							return (
								...
								(e.prototype.isItemExists = function (t) {
									return this.items.some(function (e) {
										return Array.from(e.querySelectorAll('[data-hs-combo-box-search-text]')).some(
											function (e) {
												return (
										...
										o.querySelectorAll('[data-hs-combo-box-search-text]').forEach(function (e) {
											...
											(e.textContent =
												...
												e.setAttribute(
													...
													null !== (o = t[e.getAttribute('data-hs-combo-box-output-item-field')]) &&
														void 0 !== o
														? o
														: ''
												);
								...
								(e.prototype.buildToggle = function () {
									...
									this.toggle.addEventListener('click', function () {
										t.isOpened
											? t.close()
											: t.open(t.toggle.getAttribute('data-hs-combo-box-toggle'));
									});
								}),
						...
						a = (function (t) {
							function e(e, n) {
								...
								(o.input = o.el.querySelector('[data-hs-input-number-input]') || null),
									...
									o.input &&
										(o.inputValue = isNaN(parseInt(o.input.value)) ? 0 : parseInt(o.input.value));
						...
						c = (function (t) {
							function e(e, n, o) {
								var i,
									...
									h = r(r({}, p), n);
								if (
									((u.hiddenClass = (null == h ? void 0 : h.hiddenClass) || 'hidden'),
									(u.isClosePrev =
										null === (i = null == h ? void 0 : h.isClosePrev) || void 0 === i || i),
									(u.backdropClasses =
										null !== (s = null == h ? void 0 : h.backdropClasses) && void 0 !== s
											? s
									...
									(u.backdropExtraClasses =
										null !== (c = null == h ? void 0 : h.backdropExtraClasses) && void 0 !== c
											? c
											: ''),
									(u.openNextOverlay = !1),
									(u.autoHide = null),
									...
									(u.isCloseWhenClickInside = (0, l.stringToBoolean)(
										(0, l.getClassProperty)(u.overlay, '--close-when-click-inside', 'false') ||
											'false'
									)),
										(u.isTabAccessibilityLimited = (0, l.stringToBoolean)(
											(0, l.getClassProperty)(u.overlay, '--tab-accessibility-limited', 'true') ||
												'true'
										)),
										(u.isLayoutAffect = (0, l.stringToBoolean)(
											(0, l.getClassProperty)(u.overlay, '--is-layout-affect', 'false') || 'false'
										)),
										(u.hasAutofocus = (0, l.stringToBoolean)(
											(0, l.getClassProperty)(u.overlay, '--has-autofocus', 'true') || 'true'
										)),
										(u.hasAbilityToCloseOnBackdropClick = (0, l.stringToBoolean)(
						...
						u = (function (t) {
							...
							return (
								...
								(e.prototype.buildDropdown = function () {
									(this.dropdown = (0, c.htmlToElement)(this.dropdownTemplate)),
										this.dropdownClasses &&
											(0, c.classToClassList)(this.dropdownClasses, this.dropdown),
								...
								(e.prototype.itemTemplate = function (t) {
									...
									s
										? s.append((0, c.htmlToElement)('<span>'.concat(n, '</span>')))
										: r.append((0, c.htmlToElement)('<span>'.concat(n, '</span>')));
						...
						d = (function (t) {
							function e(e, n) {
								...
								return (
									...
									(i.preventSearchFocus = (null == a ? void 0 : a.preventSearchFocus) || !1),
									...
									(i.selectedItems = []),
									(i.wrapperClasses = (null == a ? void 0 : a.wrapperClasses) || null),
									...
									(i.extraMarkup = (null == a ? void 0 : a.extraMarkup) || null),
							...
							return (
								...
								(e.prototype.buildOption = function (t, e, n, o) {
									...
									if (
										...
										this.optionTemplate &&
											((r = (0, a.htmlToElement)(this.optionTemplate)), s.append(r)),
										r
										...
										if (n.icon) {
											...
											if ((l.classList.add('mw-full'), r)) r.querySelector('[data-icon]').append(l);
												...
												this.iconClasses && (0, a.classToClassList)(this.iconClasses, c),
													c.append(l),
													s.append(c);
											}
										}
									...
									r &&
										...
										this.optionClasses && (0, a.classToClassList)(this.optionClasses, s),
									...
									(this.animationInProcess = !0),
										...
										setTimeout(function () {
											t.wrapper.classList.add('active'),
												...
												t.hasSearch && !t.preventSearchFocus && t.search.focus(),
												(t.animationInProcess = !1);
										}),
										(this.isOpened = !0);
								}),
